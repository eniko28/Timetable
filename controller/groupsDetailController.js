...
import { getTeachersByGroupId, getSubjectsByTeacherId } from '../model/teachingsDB.js';
...
export const getGroupDetails = async (req, res) => {
  try {
    ...
    const subjectsPromises = teacherIds.map((teacherId) => getSubjectsByTeacherId(db, teacherId));
